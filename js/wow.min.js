...
!function(e, t) {
  ...
  l.notSupported = !0,
  u), f = window.getComputedStyle || function(e) {
      var t = /(\-([a-z]){1})/g;
      return {
  ...
  , v = function() {
      ...
      return c(e, [{
          ...
          value: function() {
              ...
              i(document.readyState, ["interactive", "complete"]) ? this.start() : a(document, "DOMContentLoaded", this.start),
              this.finished = []
          }
      }, {
          key: "start",
          value: function() {
              ...
              (this.disabled() || (a(this.config.scrollContainer || window, "scroll", this.scrollHandler),
          ...
          value: function(e) {
              ...
              this.config.resetAnimation && (a(e, "animationend", this.resetAnimation),
