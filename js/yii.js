...
window.yii = function(t) {
  var e = {
      ...
      setCsrfToken: function(e, i) {
          ...
          t("meta[name=csrf-token]").attr("content", i)
      },
      ...
      handleAction: function(i, n) {
          var r, a = i.attr("data-form") ? t("#" + i.attr("data-form")) : i.closest("form"), o = !i.data("method") && a ? a.attr("method") : i.data("method"), c = i.attr("href"), s = c && "#" !== c, d = i.data("params"), l = d && t.isPlainObject(d), u = i.data("pjax"), p = void 0 !== u && 0 !== u && t.support.pjax, f = {};
          ...
          p && (void 0 !== (r = i.data("pjax-container")) && r.length || (r = i.closest("[data-pjax-container]").attr("id") ? "#" + i.closest("[data-pjax-container]").attr("id") : ""),
          r.length || (r = "body"),
          f = {
              container: r,
          ...
          void 0 !== o) {
              ...
              if (g) {
                  ...
                  var v = i.attr("target");
                  if (v && a.attr("target", v),
                  /(get|post)/i.test(o) || (a.append(t("<input/>", {
                      name: "_method",
                      value: o,
                      type: "hidden"
                  })),
              ...
              a.trigger("submit"),
              t.when(a.data("yiiSubmitFinalizePromise")).done((function() {
                  g ? a.remove() : (void 0 !== h && a.attr("action", h),
                  a.attr("method", m),
                  l && t.each(d, (function(e) {
              ...
              s ? p ? t.pjax.click(n, f) : window.location.assign(c) : i.is(":submit") && a.length && (p && a.on("submit", (function(e) {
                  t.pjax.submit(e, f)
              }
              )),
              a.trigger("submit"))
      ...
      getQueryParams: function(e) {
          ...
          for (var n = t.grep(e.substring(i + 1).split("#")[0].split("&"), (function(t) {
              ...
              s.length && (void 0 === r[s] ? r[s] = d || "" : (t.isArray(r[s]) || (r[s] = [r[s]]),
              r[s].push(d || "")))
          }
          return r
      },
      initModule: function(i) {
          (void 0 === i.isActive || i.isActive) && (t.isFunction(i.init) && i.init(),
          t.each(i, (function() {
              ...
              if ("jsonp" != t.dataType) {
                  ...
                  a.done((function(t, e, i) {
                      ...
                      if ("abort" !== e) {
                          ...
                          for (var i = !0, n = 0, a = r[t.yiiUrl].xhrList.length; n < a; n++)
                              r[t.yiiUrl].xhrList[n] && (i = !1);
                          i && delete r[t.yiiUrl]
                      }
                  }
                  )),
                  a.yiiIndex = r[o].xhrList.length,
                  a.yiiUrl = o,
                  r[o].xhrList[a.yiiIndex] = a)
              }
          }
          )),
